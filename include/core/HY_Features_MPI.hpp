...
namespace hy_features {
    ...
    class HY_Features_MPI : public HY_Features{
      public:
        HY_Features_MPI( PartitionData partition_data,geojson::GeoJSON catchments, std::string* link_key, std::shared_ptr<Formulation_Manager> formulations, int mpi_rank, int mpi_num_procs);
