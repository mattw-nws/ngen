...
## About
This submodule is current linked in from: https://github.com/mattw-nws/CopyCat . This directory follows the template for linking submodules from https://github.com/NOAA-OWP/ngen/edit/master/extern/cfe/.
...
To fetch and check out the latest revision (for the [currently used branch](#viewing-the-current-branch)):
    ...
    git submodule update --init -- extern/copycat/copycat

To commit the current submodule checkout revision to the CIROH UA NGen repo:

    git add extern/copycat/copycat
    git commit
